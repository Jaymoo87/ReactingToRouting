      ...
      <div key={`person-card-${details?.id}`} className="d-block col-12 col-md-6 col-sm-12 mt-4">
        <div className="mb-2 card shadow-lg">
          ...
          <div className="d-flex justify-content-around mx-2 p-3">
            <h5 className="text-muted card-text fst-italic">Gender: {details?.gender}</h5>
            <h5 className="  text-muted card-text fst-italic mx-2">Age {details?.age}</h5>
          </div>
          ...
          <div className="btn d-flex justify-content-start ">
            <Link to="/people" className=" shadow-lg border-radius-pill btn btn-sm btn-secondary btn-outline-light">
              Go Back
            </Link>
          </div>
        </div>
